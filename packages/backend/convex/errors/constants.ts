...
/**
 * WorkOS API error codes
 */
export const WorkOSErrorCode = {
	AUTHENTICATION_FAILED: "WORKOS_AUTHENTICATION_FAILED",
	CREATE_USER_FAILED: "WORKOS_CREATE_USER_FAILED",
	DELETE_USER_FAILED: "WORKOS_DELETE_USER_FAILED",
	EMAIL_VERIFICATION_FAILED: "WORKOS_EMAIL_VERIFICATION_FAILED",
	SEND_VERIFICATION_EMAIL_FAILED: "WORKOS_SEND_VERIFICATION_EMAIL_FAILED",
	RESET_PASSWORD_FAILED: "WORKOS_RESET_PASSWORD_FAILED",
} as const;

export type WorkOSErrorCode =
	(typeof WorkOSErrorCode)[keyof typeof WorkOSErrorCode];
