...
function FieldSeparator({
  ...
  return (
    <div
      className={cn(
        "relative -my-2 flex h-5 flex-row items-center text-xs/relaxed group-data-[variant=outline]/field-group:-mb-2",
        className
      )}
    ...
    >
      ...
      {children && (
        <span
          className="w-fit shrink-0 px-2 text-muted-foreground text-xs"
