...
function Card({
	...
	return (
		<div
			...
			data-size={size}
			className={cn(
				"ring-foreground/0 bg-card text-card-foreground gap-4 overflow-hidden rounded-[20px] corner-superellipse/1.2 py-4 text-xs/relaxed shadow-glass-secondary ring-1 has-[>img:first-child]:pt-0 data-[size=sm]:gap-3 data-[size=sm]:py-3 *:[img:first-child]:rounded-t-lg *:[img:last-child]:rounded-b-lg group/card flex flex-col",
				className,
			)}
			{...props}
		/>
