...
function ComboboxInput({
	...
	return (
		<InputGroup
			className={cn(
				"w-auto rounded-full border-0 shadow-glass-secondary ring-0 ring-foreground/0 transition-all duration-100 bg-input/50 dark:bg-white/5 has-[[data-slot=input-group-control]:hover]:bg-input/50 has-[[data-slot=input-group-control]:focus-visible]:bg-input/50 dark:has-[[data-slot=input-group-control]:hover]:bg-white/7.5 dark:has-[[data-slot=input-group-control]:focus-visible]:bg-white/7.5 has-[[data-slot=input-group-control]:focus-visible]:ring-3 has-[[data-slot=input-group-control]:focus-visible]:ring-offset-black/50 has-[[data-slot=input-group-control]:focus-visible]:ring-offset-0 has-[[data-slot=input-group-control]:focus-visible]:ring-foreground/5 has-[[data-slot=input-group-control]:focus-visible]:shadow-glass-secondary-focus",
				className,
			)}
		>
		...
		<ComboboxPrimitive.Portal>
			...
			>
				<ComboboxPrimitive.Popup
					...
					data-chips={!!anchor}
					className={cn(
						"bg-popover text-popover-foreground data-open:animate-in data-closed:animate-out data-closed:fade-out-0 data-open:fade-in-0 data-closed:zoom-out-95 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 ring-foreground/0 shadow-glass-secondary *:data-[slot=input-group]:bg-input/20 dark:bg-popover max-h-72 min-w-32 overflow-hidden rounded-[14px] ring-1 duration-100 *:data-[slot=input-group]:m-1 *:data-[slot=input-group]:mb-0 *:data-[slot=input-group]:h-7 *:data-[slot=input-group]:border-none *:data-[slot=input-group]:shadow-none group/combobox-content relative max-h-(--available-height) w-(--anchor-width) max-w-(--available-width) min-w-[calc(var(--anchor-width)+--spacing(7))] origin-(--transform-origin) data-[chips=true]:min-w-(--anchor-width)",
						className,
					)}
					{...props}
				/>
