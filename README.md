...
A Bun and Turborepo starter for a TanStack Start product with Clerk authentication, Convex, Stripe billing, Resend email, shared Base UI components, and an Electron desktop shell.
